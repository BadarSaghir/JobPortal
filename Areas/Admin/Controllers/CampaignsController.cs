...
if (isSystemBusy) {
    ...
    return RedirectToAction(nameof(Index));
        ...
        {
            TempData["Info"] = "A Candidate  export is currently being generated. Please wait.";
            return RedirectToAction(nameof(Index));
        }
        ...
        TempData["Success"] = "The export task has been queued. Large Candidate  will take a few minutes to process.";
        return RedirectToAction(nameof(Index));
    }
