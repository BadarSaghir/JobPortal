...
BEGIN
    ...
    VALUES (N'20260421074347_Addres', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260421085252_Ad0dres', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260421101234_Added_columns', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260421113421_Added_columns_appliedAt', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260421123859_Added_cnic_rm', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260421151039_Added_cnic_geneder', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260421160632_Added_inv', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260422034727_data_fixed', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260422050647_Added_colv', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260423070247_FinalArchitecture', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260423104654_AddApplicationsNavigation', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260424053523_Added_notication', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260424064345_Added_audit_notication', N'10.0.7');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260424064730_Added_audit_notication_correction', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260424144112_Added_support_ticket_correction'
)
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260424144112_Added_support_ticket_correction', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425065243_NameChanging'
)
BEGIN
    ALTER TABLE [ApplicationStatusHistory] DROP CONSTRAINT [FK_ApplicationStatusHistory_JobApplications_JobApplicationId];
END;
...
BEGIN
    ALTER TABLE [ApplicationStatusHistory] DROP CONSTRAINT [FK_ApplicationStatusHistory_Users_ChangedByUserId];
END;
...
BEGIN
    ALTER TABLE [Users] DROP CONSTRAINT [FK_Users_Designations_DesignationId];
END;
...
BEGIN
    ALTER TABLE [Users] DROP CONSTRAINT [FK_Users_PayScales_PayScaleId];
END;
...
BEGIN
    ALTER TABLE [ApplicationStatusHistory] DROP CONSTRAINT [PK_ApplicationStatusHistory];
END;
...
BEGIN
    EXEC sp_rename N'[Roles]', N'AspNetRoles', 'OBJECT';
END;
...
BEGIN
    EXEC sp_rename N'[ApplicationStatusHistory]', N'ApplicationStatusHistories', 'OBJECT';
END;
...
BEGIN
    EXEC sp_rename N'[AspNetUsers].[IX_Users_PayScaleId]', N'IX_AspNetUsers_PayScaleId', 'INDEX';
END;
...
BEGIN
    EXEC sp_rename N'[AspNetUsers].[IX_Users_DesignationId]', N'IX_AspNetUsers_DesignationId', 'INDEX';
END;
...
BEGIN
    EXEC sp_rename N'[AspNetUsers].[IX_Users_DepartmentId]', N'IX_AspNetUsers_DepartmentId', 'INDEX';
END;
...
BEGIN
    EXEC sp_rename N'[ApplicationStatusHistories].[IX_ApplicationStatusHistory_JobApplicationId]', N'IX_ApplicationStatusHistories_JobApplicationId', 'INDEX';
END;
...
BEGIN
    EXEC sp_rename N'[ApplicationStatusHistories].[IX_ApplicationStatusHistory_ChangedByUserId]', N'IX_ApplicationStatusHistories_ChangedByUserId', 'INDEX';
END;
...
BEGIN
    ALTER TABLE [ApplicationStatusHistories] ADD CONSTRAINT [PK_ApplicationStatusHistories] PRIMARY KEY ([Id]);
END;
...
BEGIN
    ALTER TABLE [ApplicationStatusHistories] ADD CONSTRAINT [FK_ApplicationStatusHistories_AspNetUsers_ChangedByUserId] FOREIGN KEY ([ChangedByUserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION;
END;
...
BEGIN
    ALTER TABLE [ApplicationStatusHistories] ADD CONSTRAINT [FK_ApplicationStatusHistories_JobApplications_JobApplicationId] FOREIGN KEY ([JobApplicationId]) REFERENCES [JobApplications] ([Id]) ON DELETE CASCADE;
END;
...
BEGIN
    ALTER TABLE [AspNetUsers] ADD CONSTRAINT [FK_AspNetUsers_Designations_DesignationId] FOREIGN KEY ([DesignationId]) REFERENCES [Designations] ([Id]) ON DELETE NO ACTION;
END;
...
BEGIN
    ALTER TABLE [AspNetUsers] ADD CONSTRAINT [FK_AspNetUsers_PayScales_PayScaleId] FOREIGN KEY ([PayScaleId]) REFERENCES [PayScales] ([Id]) ON DELETE NO ACTION;
END;
...
BEGIN
    ALTER TABLE [RolePermissions] ADD CONSTRAINT [FK_RolePermissions_AspNetRoles_RoleId] FOREIGN KEY ([RoleId]) REFERENCES [AspNetRoles] ([Id]) ON DELETE CASCADE;
END;
...
BEGIN
    ALTER TABLE [UserNotifications] ADD CONSTRAINT [FK_UserNotifications_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE CASCADE;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260425065243_NameChanging', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260425083709_NameChangingFixesProvince'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260425083709_NameChangingFixesProvince', N'10.0.7');
END;
